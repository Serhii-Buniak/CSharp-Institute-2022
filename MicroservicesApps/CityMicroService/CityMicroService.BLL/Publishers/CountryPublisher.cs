...
public class CityPublisher
{
    ...
    public void CreateEvent(CityDTO country) => SendEvent(country, "Create");
    public void DeleteEvent(CityDTO country) => SendEvent(country, "Delete");
    public void UpdateEvent(CityDTO country) => SendEvent(country, "Update");


    private void SendEvent(CityDTO country, string eventAction)
    {
        ModelPublished modelPublished = _mapper.Map<CityPublished>(country);
